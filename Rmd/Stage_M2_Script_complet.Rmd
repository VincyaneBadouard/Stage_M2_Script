...
```{r chargement de la base de donnees originale de Marco}

Marco_raw <- read_delim("../Csv/data_FT.csv", ";", escape_double = FALSE, locale = locale(decimal_mark = ","), trim_ws = TRUE)
...
```{r Charger la base de donnees post-terrain}

DATABASE <- read_delim("../Csv/DATABASE.csv", ";", escape_double = FALSE, locale = locale(decimal_mark = ","), trim_ws = TRUE)
...
leaves_area <- read_csv("../Csv/Summary of Leaves.csv")
...
roots_area <- read_csv("../Csv/Summary of Roots.csv")
...
Data_Tene <- read_delim("../Csv/data_final.csv",
...
My_lengths <- read_csv("../Csv/results_length.csv")
...
rawmissingdataMarco <- read_delim("../Csv/roots computation.csv", 
...
Marco_lengths <- read_csv("../Csv/Marco_lengths.csv", 
...
roots_area_Marco <- read_csv("../Csv/Summary areas of Roots scans Marco.csv", locale = locale(encoding = "latin1")) %>% 
  select(Slice, "Total Area")
...
write.csv2(Ourbase_MarcoRoots, "../Csv/Traits_base_complete.csv")
...
write.csv2(Traitsbase_means, "../Csv/Traitsbase_fordiversity.csv")
...
# plot(TENEtree$Scenario.2,cex = 1.1,main ="Scenarion Two")
# plot(TENEtree$Scenario.3,cex = 1.1,main ="Scenarion Three")
```
...
data_subplot <- read_delim("../Csv/data_subplot.csv", 
    ";", escape_double = FALSE, locale = locale(decimal_mark = ","), 
    trim_ws = TRUE)
...
png(file = "C:/Users/Utilisateur/Desktop/Stage M2 Côte d'Ivoire/Figures/Regressions.png", width=1180, height=900)  
...
png(file = "C:/Users/Utilisateur/Desktop/Stage M2 Côte d'Ivoire/Figures/density curve.png", width=738, height=512)  
...
png(file = "C:/Users/Utilisateur/Desktop/Stage M2 Côte d'Ivoire/Figures/density curve & histogram.png", width=738, height=512)    
...
png(file = "C:/Users/Utilisateur/Desktop/Stage M2 Côte d'Ivoire/Figures/histogram with-without sylviculture.png", width=738, height=512)    
...
png(file = "C:/Users/Utilisateur/Desktop/Stage M2 Côte d'Ivoire/Figures/density curve with-without sylviculture.png", width=738, height=512)    
...
# Correlation plot:
png(file = "C:/Users/Utilisateur/Desktop/Stage M2 Côte d'Ivoire/Figures/corrplot_var.png", width=738, height=512)    
...
png(file = "C:/Users/Utilisateur/Desktop/Stage M2 Côte d'Ivoire/Figures/Regressions with-without sylviculture.png", width=1180, height=900)  
...
write.csv2(covariantsdata_classes, "../Csv/covariantsdata_classes.csv")
...
png(file = "C:/Users/Utilisateur/Desktop/Stage M2 Côte d'Ivoire/Figures/Regressions_under Cedrela proportion.png", width=1180, height=900)    
...
png(file = "C:/Users/Utilisateur/Desktop/Stage M2 Côte d'Ivoire/Figures/Regressions_under fire proportion.png", width=1180, height=900)    
